...
class BLProduct(models.Model):
    ...
    def update_price(self, price):
        if price != self.current_price:
            ...
            self.save()
            BLPriceHistory(product=self, price=price).save()
...
class BLPriceHistory(models.Model):
    product = models.ForeignKey(BLProduct, related_name='price_history')
...
class BLImage(models.Model):
    product = models.ForeignKey(BLProduct, related_name='images')
